...
[![PRs welcome!](https://img.shields.io/badge/PRs-Welcome-FF6F61)](https://github.com/ArmsSwordSeparator/stackprism-938/issues)
...
```bash
git clone https://github.com/ArmsSwordSeparator/stackprism-938.git
cd stackprism-938
python setup.py
```
...
- **Bug / 误识 / 漏识反馈**:[Issues](https://github.com/ArmsSwordSeparator/stackprism-938/issues) — popup 上直接点「识别不准确」按钮会自动填好议题模板
- **规则贡献**:扩展设置页点「提交规则贡献」,或直接 PR 到 [`public/rules/`](public/rules/)
- **讨论与提案**:[Discussions](https://github.com/ArmsSwordSeparator/stackprism-938/discussions)
...
<!-- Last updated: 2026-06-06 20:14:14 -->
